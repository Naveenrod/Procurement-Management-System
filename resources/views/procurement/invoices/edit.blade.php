<x-app-layout>
    ...
    <div class="py-6 max-w-4xl">
        <form method="POST" action="{{ route('procurement.invoices.update', $invoice) }}">
            @csrf @method('PUT')
            ...
            <div class="flex justify-end gap-3 mt-4">
                <a href="{{ route('procurement.invoices.show', $invoice) }}" class="px-4 py-2 border rounded-md text-sm text-gray-700">Cancel</a>
