<x-app-layout>
    ...
    <div class="py-6 max-w-4xl">
        <form method="POST" action="{{ route('procurement.purchase-orders.update', $order) }}">
            @csrf @method('PUT')
            ...
            <div class="flex justify-end gap-3 mt-4">
                <a href="{{ route('procurement.purchase-orders.show', $order) }}" class="px-4 py-2 border rounded-md text-sm text-gray-700">Cancel</a>
