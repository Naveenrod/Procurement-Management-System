    ...
    <div class="bg-white rounded-lg shadow-sm border overflow-hidden">
        <table class="w-full text-sm">
            ...
            <tbody class="divide-y">
                @foreach($rfqs as $rfqVendor)
                @php $rfq = $rfqVendor->rfq; @endphp
                <tr class="hover:bg-gray-50">
                    ...
                    <td class="px-4 py-3"><span class="text-xs {{ $rfqVendor->responded_at ? 'text-green-600' : 'text-gray-400' }}">{{ $rfqVendor->responded_at ? 'Submitted' : 'Pending' }}</span></td>
